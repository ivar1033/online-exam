    ...
    <br>
     <div class="form-group ">
       <select name="collegename" class="form-control">
          ...
          <option value="-1">Select College Name</option>
          <option value="B. P. Poddar Institute of Management & Technology" id="bppimt">B. P. Poddar Institute of Management & Technology</option>
        </select>
     ...
     <div class="form-group ">
       <input type="text" class="form-control" placeholder="College ID " id="collegeid" name="collegeid">
     </div>
     
     <div class="form-group log-status">
       <input type="password" class="form-control" placeholder="Password" id="password" name="password_1">
     ...
     <button type="submit" name="signup-college" class="log-btn" >Sign Up</button> 
