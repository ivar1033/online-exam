        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/semester/semester-5.php">HOME</a></li>
    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="mca_e503b">SUBMIT</button>
                    <br><br>
                     <button class="button button3" type="submit" name="rmca_e503b">Delete Question Bank</button>
</form>
...
<h2><strong>QUESTION PAPER</strong></h2>
            <?php
                ...
                $sql = "SELECT  question, A, B, C, D, correct  FROM mca_e503b";
                $result = $db->query($sql);
                $q = 1;
