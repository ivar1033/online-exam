    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="hu_501">SUBMIT</button>
                    <br><br>
                    <button class="button button3" type="submit" name="rhu_501">Delete Question Bank</button>
...
<h2><strong>QUESTION PAPER</strong></h2>
            <?php
                ...
                $sql = "SELECT  question, A, B, C, D, correct  FROM hu_501";
                $result = $db->query($sql);
                $q = 1;
