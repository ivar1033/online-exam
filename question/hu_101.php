    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="hu_101">SUBMIT</button>
                    <br><br>
                    <button class="button button3" type="submit" name="rhu_101">Delete Question Bank</button>
...
<br><br>
        ...
        <br>
            <?php
                ...
                $sql = "SELECT  id, question, A, B, C, D, correct  FROM hu_101";
                $result = $db->query($sql);
                $q = 1;
