    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="mm_301">SUBMIT</button>
                    <br><br>
                     <button class="button button3" type="submit" name="rmm_301">Delete Question Bank</button>
</form>
...
<h2><strong>QUESTION PAPER</strong></h2>
            <?php
                ...
                $sql = "SELECT  question, A, B, C, D, correct  FROM mm_301";
                $result = $db->query($sql);
                $q = 1;
