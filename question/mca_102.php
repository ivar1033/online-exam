    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="mca_102">SUBMIT</button>
                    <br><br>
                     <button class="button button3" type="submit" name="rmca_102">Delete Question Bank</button>
...
$sql = "SELECT  question, A, B, C, D, correct  FROM mca_102";
$result = $db->query($sql);
$q = 1;
