        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/semester/semester-1.php">HOME</a></li>
    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="mca_103">SUBMIT</button>
                    <br><br>

                     <button class="button button3" type="submit" name="rmca_103">Delete Question Bank</button>
...
<h2><strong>QUESTION PAPER</strong></h2>
            <?php
                ...
                $sql = "SELECT  question, A, B, C, D, correct  FROM mca_103";
                $result = $db->query($sql);
                $q = 1;
