    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="mca_202">SUBMIT</button>
                    <br><br>
                    <button class="button button3" type="submit" name="rmca_202">Delete Question Bank</button>
...
<h2><strong>QUESTION PAPER</strong></h2>
            <?php
                ...
                $sql = "SELECT  question, A, B, C, D, correct  FROM mca_202";
                $result = $db->query($sql);
                $q = 1;
