    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="hu_401">SUBMIT</button>
                    <br><br>
                    <button class="button button3" type="submit" name="rhu_401">Delete Question Bank</button>
...
<h2><strong>QUESTION PAPER</strong></h2>
            <?php
                ...
                $sql = "SELECT  question, A, B, C, D, correct  FROM hu_401";
                $result = $db->query($sql);
                $q = 1;
