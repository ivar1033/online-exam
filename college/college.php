            ...
            <div class="container">
                <div class="row scroll-me">
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 text-center ">
                        ...
                        <h2 data-scroll-reveal="enter from the bottom after 0.4s">BY MAKING COLLEGE UNAFFORDABLE AND STUDENT LOANS UNBEARABLE, WE RISK DETERRING OUR BEST AND BRIGHTEST FROM PURSUING HIGHER EDUCATION AND SECURING A GOOD PAYING JOB
                        </h2>
        ...
        <div class="container">
            ...
            <div class="row text-center pad-bottom" data-scroll-reveal="enter from the bottom after 0.2s">
                <div align="center">
                    ...
                    <a href="/college/student.php"><h4><strong> <button class="button button1">Submit Students Names</button> </strong></h4></a>
                   
                </div>
                <div align="center" ">
   
                    <a href="/college/teacher.php"><h4><strong><button class="button button2"> Submit Teachers Names</button> </strong></h4></a>
