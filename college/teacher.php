    ...
    <section id="services">
            ...
            <div class="row text-center">
                <form  method="post">
                    ...
                    <h2><strong>INSERT TEACHERS DETAILS</strong></h2>
                    <br>
                    ...
                    <br><br>
                    <button class="button button1" type="submit" name="submit_teacher">SUBMIT</button>
                    <br><br>
                    <button class="button button3" type="submit" name="reset_teacher">RESET</button>
</form>
...
<br><br>
        <div align="center">
        <h2><strong>TEACHERS LIST FOR SUBMITTING QUESTION PAPER</strong></h2>
            <?php

                $sql = "SELECT  name, email  FROM eligibleteacher";
                $result = $db->query($sql);
                $q = 1;
                if ($result->num_rows > 0) {
                    echo "<table class='w3-table-all w3-card-4 w3-large'><tr class='w3-yellow'><th>SL.NO</th><th>NAME</th><th>EMAIL</th></tr>";
                    // output data of each row
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr><td>" . $q . "</td><td>" . $row["name"] . " </td><td>" . $row["email"] . "</td></tr>";
                        $q++;
                    }
                    echo "</table>";
                } else {
