            ...
            <div class="container">
                <div class="row scroll-me">
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 text-center ">
                        ...
                        <h2 data-scroll-reveal="enter from the bottom after 0.4s"> STUDY LIKE THERE’S NO TOMORROW BECAUSE IF YOU KEEP PUTTING OFF YOUR STUDIES FOR TOMORROW, YOU’LL PROBABLY BE TOO LATE
        ...
        <div class="container">
            ...
            <div class="row text-center pad-bottom" data-scroll-reveal="enter from the bottom after 0.2s">
                ...
                <div class="center">
                    ...
                    <button class="button button1" type="submit" name="exam">GIVE EXAM</button>
                ...
                <div class="center">
                    ...
                    <a href ="result.php"><button class="button button2" type="submit" name="result">RESULT</button></a>
